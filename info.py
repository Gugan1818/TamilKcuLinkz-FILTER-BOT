...
API_ID = int(environ.get('15101806', ''))
API_HASH = environ.get('47c0fb34b325f4fc23d71622da276cd3', '')
BOT_TOKEN = environ.get('7524379217:AAEQNMOvCRwXMnfC5BRciAJ_ZpbTZ5CHCZc', "")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('1259674407', '').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('-1002570874535', ''))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('-1001733823205', '').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('-1002825633058', '') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('mongodb+srv://gugan493:<db_gugan1818>@cluster0.qidmwzd.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', "")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+TSlKIqe5CHxhZWY9')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/TamilKcuLinkz')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+AlwXOmAJsGE4MTE1') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', '@TamilKcu_Adminbot')
